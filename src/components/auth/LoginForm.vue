...
const onSubmit = form.handleSubmit(async (values) => {
  ...
  try {
    ...
    // Redirect to home page or the page user tried to access
  ...
  <div :class="cn('flex flex-col gap-6', props.class)">
    <Card class="overflow-hidden p-0">
      <CardContent class="grid p-0 md:grid-cols-2">
        <form class="p-6 md:p-8" @submit.prevent="onSubmit" novalidate>
          <FieldGroup>
            ...
            <FormField v-slot="{ componentField }" name="email">
              <FormItem>
                ...
                <FormControl>
                  <Input type="email" placeholder="shadcn@example.com" v-bind="componentField" />
                </FormControl>
                <FormMessage />
              </FormItem>
            </FormField>
